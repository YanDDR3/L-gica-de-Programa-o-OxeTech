programa {
  ...
  funcao inteiro sortearNumero(inteiro intervalo){
    retorne util.sorteia(1,intervalo) // aqui você tá pe
  }
  funcao atraso (){
    util.aguarde(1000)
    escreva(".")
  ...
  funcao mensagemIncio(inteiro intervalo){
  ...
  funcao inteiro escolherDificuldade(){
      ...
      escreva("2 - Médio (1 a 1.000)\n")
      escreva("3 - Dificil (1 a 10.000)\n")
  ...
  funcao inteiro definirIntervalo(inteiro nivel){
    inteiro intervalo
      ...
      escolha(nivel){
        ...
        caso contrario:
          intervalo = 100
          escreva("\n Opção inválida. Dificuldade redefinida para 'fácil'. \n ")
          pare
      }
